...
<div id="review-container">
    ...
    -->
            ...
            foreach ($travel_reviews as $single_review) { ?>
                <section class="review">
                <h2 class= "location"> <?php echo $single_review["location"] . "<br>"; ?> </h2>
                <p class= "author"> <?php echo $single_review["author"] . "<br>"; ?> </p>
                <p class="date"> <?php echo $single_review["date"] . "<br>"; ?> </p>
                <p class="comments"> <?php echo $single_review["comments"] . "<br>"; ?> </p> </section>
                <?php }?>
